...
GBufferFBO::GBufferFBO(int w, int h)
{
	_w = w;
	_h = h;
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB16F_ARB, _w, _h, 0, GL_RGB, GL_FLOAT, NULL);
...
unsigned int GBufferFBO::GetW()
{
	return _w;
}

unsigned int GBufferFBO::GetH()
{
	return _h;
}
