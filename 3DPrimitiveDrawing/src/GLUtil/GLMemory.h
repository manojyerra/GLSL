...
#define GLCreateMSTexture(a, b, c, d)			GLMemory::CreateMSTexture(a, b, c, d, __FILE__, __LINE__)
#define GLCreateRenderBuffer(a, b, c)			GLMemory::CreateRenderBuffer(a, b, c, __FILE__, __LINE__)
#define GLCreateMSRenderBuffer(a, b, c, d)		GLMemory::CreateMSRenderBuffer(a, b, c, d, __FILE__, __LINE__)
...
public:
	...
	static GLuint CreateMSTexture(int numSamples, GLint internalFormat, GLsizei w, GLsizei h, const char* filePath, long lineNum);

	static GLuint CreateRenderBuffer(GLsizei width, GLsizei height, GLenum internalformat, const char* filePath, long lineNum);
	static GLuint CreateMSRenderBuffer(int numSamples, GLsizei width, GLsizei height, GLenum internalformat, const char* filePath, long lineNum);
