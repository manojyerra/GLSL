...
GLMesh::GLMesh(string folderPath, int type)
{
	_vertexBufferID = 0;
	_normalBufferID = 0;
	_uvBufferID = 0;
...
GLMesh* GLMesh::SetVertexArray(const float* arr)
{
	return NULL;
}

GLMesh* GLMesh::SetNormalArray(const float* arr)
{

}

GLMesh* GLMesh::SetUVArray(const float* arr)
{

}

GLMesh* GLMesh::SetImageBuffer(ImageBuffer* imgBuf)
{
...
void GLMesh::Init(string folderPath, bool writeBinaryToFile)
{
	_vertexCount = 0;
...
void GLMesh::ReadObjFile(string folderPath)
{
...
void GLMesh::WriteBinaryToFile(string folderPath,
...
void GLMesh::LoadTextures(string folderPath)
{
