...
private:
	...
	Rect2D GetBounding2DRect(bool multWithLocalMat);
...
public:
	...
	Shape* AddBestBoudingShapeByVerticesOnRect(Rect2D* rect);
	Shape* AddBoudingShapeByVerticesOnRect(Rect2D* rect, int boundingShapeID);
